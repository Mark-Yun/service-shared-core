...
const config = {
  ...
  // cacheDirectory: "/private/var/folders/t_/9trxgg_x7c3fq36n6p2t83r00000gn/T/jest_dx",
  ...
  transformIgnorePatterns: ['/node_modules/'], // node_modules를 변환에서 제외
  ...
  // extensionsToTreatAsEsm: ['.js'], // ESM으로 처리할 확장자
};
